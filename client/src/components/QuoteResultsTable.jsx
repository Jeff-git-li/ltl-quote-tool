...
const QuoteResultsTable = ({ rates }) => {
  const rows = rates.map((r, index) => ({
    ...
    estimatedPickupDate: new Date(r.estimatedPickupDate).toLocaleString(),
    estimatedDeliveryDate: new Date(r.estimatedDeliveryDate).toLocaleString(),
  ...
  const columns = [
    ...
    { field: 'services', headerName: 'Services', flex: 2 },
    { field: 'price', headerName: 'Price', flex: 1 },
    { field: 'estimatedPickupDate', headerName: 'Pickup Date', flex: 2 },
    { field: 'estimatedDeliveryDate', headerName: 'Delivery Date', flex: 2 },
